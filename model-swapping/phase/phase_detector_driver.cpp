...
void read_file(char const log_file[], int is_binary /*= 1*/) {
    ...
    if (is_binary == 1) {
        ...
        while (in_stream.good()) {
            ...
            //time for struct with inlined fxns on amg 50: 11.196s
            //time for struct with non inlined on amg 50: 10.704s
            //time for struct with non inlined and static and fewer vars: slower
