...
uint64_t phase_detector::hash_address(uint64_t address) {
    ...
    uint32_t hashed_randomized_address = hash_bitvec(address_minus_bottom_drop_bits);
    ...
    //MT: mt19937(address_minus_bottom_drop_bits)() - time test on big XS: tooooo long???
